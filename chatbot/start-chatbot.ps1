...
Write-Host "Iniciando chatbot en la carpeta: $scriptDir" -ForegroundColor Cyan
Write-Host "Puerto y BACKEND_URL se leen de .env (ej. PORT=4999, BACKEND_URL=http://localhost:3006/api/v1)" -ForegroundColor Gray
Write-Host ""
